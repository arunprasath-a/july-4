...
//method 2 with HOC
import React from 'react';
import SerialHOC from "../HOC/TEST_HOC/serialchartHOC";
...
class SerialChart extends React.Component {
  ...
  componentDidUpdate() {
    var chart = am4core.create("Serieschartdiv", am4charts.RadarChart);
    chart.data = this.props.radarchartData.data;
...
render() {
    ...
    return this.props.RadarchartComponent ? (
      <React.Fragment>
        <RadarchartComponent />
      </React.Fragment>
...
export default SerialHOC(SerialChart);
