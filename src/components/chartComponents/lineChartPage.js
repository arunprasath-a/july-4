...
import React from 'react';
import LineHOC from "../HOC/TEST_HOC/linechartHOC";
...
class LineChart extends React.Component {
  ...
  componentDidUpdate() {
    ...
    chart.data = this.props.linechartData.data;
...
render() {
    ...
    return this.props.LineChartComponent ? (
      <React.Fragment>
        <LineChartComponent />
      </React.Fragment>
...
export default LineHOC(LineChart);
